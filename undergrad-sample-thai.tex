...
\chapter{ผลการดำเนินงาน}
  ...
  \section{Application}
      ...
      1              & หาเนื้อหาโดยใช้เลขอ้างอิงที่มีอยู่ในระบบ        & แสดงรายละเอียดเนื้อหา                       &              \\
      2              & หาเนื้อหาโดยใช้เลขอ้างอิงที่ไม่มีอยู่ในระบบ     & ขึ้นไม่พบเนื้อหา                            &              \\
      3              & หาคำร้องขอโดยใช้เลขอ้างอิงที่มีอยู่ในระบบ       & แสดงรายละเอียดคำร้องขอ                      &              \\
      4              & หาคำร้องขอโดยใช้เลขอ้างอิงที่ไม่มีอยู่ในระบบ    & ขึ้นไม่พบคำร้องขอ                           &              \\
      5              & ส่งคำร้องขอ                                     & สามารถส่งคำร้องขอได้                        &              \\
      6              & สร้าง Api Key                                   & สามารถสร้าง Api Key ใหม่ได้                 &              \\
      7              & เข้าสู่ระบบด้วยข้อมูลที่ถูกต้อง                 & เข้าสู่ระบบได้                              &              \\
      8              & เข้าสู่ระบบด้วย username ในระบบแต่ password ผิด & ไม่สามารถเข้าสู่ระบบได้                     &              \\
      9              & เข้าสู่ระบบด้วย username ที่ไม่ถูกต้อง          & ไม่สามารถเข้าสู่ระบบได้                     &              \\
      10             & ขอข้อมูลโปรไฟล์                                 & แสดงรายละเอียดข้อมูลของตนเอง                &              \\
      11             & ขอข้อมูลโปรไฟล์ที่ไม่มีอยู่                     & ขึ้นไม่พบโปรไฟล์                            &              \\
      12             & สมัครสมาชิกใหม่                                 & สมัครสมาชิกสำเร็จ                           &              \\
      13             & สมัครสมาชิก ด้วย username ที่มีอยู่ในระบบ       & สมัครสมาชิกไม่สำเร็จ                        &              \\
      14             & ทดสอบ middleware admin                          & เฉพาะ role admin เข้าถึงได้                 &              \\
      15             & ทดสอบ middleware member                         & เฉพาะ role member เข้าถึงได้                &              \\
      16             & ทดสอบ middleware require login                  & เฉพาะคนที่ login แล้วเข้าถึงได้             &              \\
      17             & ทดสอบ middleware api key                        & เฉพาะคนที่ใส่ token ถูกต้องสามารถเข้าถึงได้ &              \\
      18             & ทดสอบ middleware api key ไม่พบ api key ในระบบ   & ปฎิเสธการเข้าถึง                            &              \\
      19             & ทดสอบ middleware api key ไม่แนบ api key         & ปฎิเสธการเข้าถึง                            &             
      \end{tabular}
      \end{table}
        \begin{figure}[!ht]\centering
