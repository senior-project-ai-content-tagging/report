...
Random Forest with TF-IDF, K-Neighbor Nearest with TF-IDF และ LSTM
...
\chapter{ผลการดำเนินงาน}
  ...
  \section{การออกแบบโมเดลสำหรับวิเคราะห์หมวดหมู่ของเนื้อหาในบทความต่าง ๆ}
    ...
    \subsection{การทดสอบโมเดล}
      ...
      \begin{longtable}[!ht]{lccccccccc}
        ...
        \multicolumn{7}{l}{\textbf{เฉลี่ย}}     & \textbf{94.33} & \textbf{94.52} \\ \hhline{=========}
        \end{longtable}
  ...
  \section{การประเมินผลและความเห็นจากผู้ใช้งาน}
    ...
    \subsection{สรุปผลการสำรวจจากแบบสอบถาม}
      ...
      และมีค่าเฉลี่ยคะแนนด้านประสิทธิภาพอยู่ที่ 4.35 ซึ่งถือเป็นค่าในช่วงเกณฑ์ "ดีมาก" ถึง "ดีมากที่สุด" 
