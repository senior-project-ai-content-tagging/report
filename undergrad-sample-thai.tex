...
\section{เทคนิคและเทคโนโลยีที่ใช้}
  \subsection{Development Tools}
    \begin{itemize}
      ...
      \item Java
      \hspace{1cm}เป็นภาษาเขียนโปรแกรมที่ได้รับความนิยมเป็นอย่างมาก มีการใช้งานอย่างกว้างขวาง เป็นจากมีประสิทธิภาพการทำงานสูง และสามารถรันได้ในทุก Platform โดย
      ไม่ต้องทำการ Compile Code ใหม่ผ่าน JVM (Java Virtual Machine) เนื่องด้วยเป็นภาษาที่มีการพัฒนาต่อเนื่องมาอย่างยาวนาน จึงทำให้มี Library ให้เลือกใช้งานมากมาย
            โดยรูปแบบการเขียนโปรแกรมภาษา Java จะเขียนโดยใช้หลักการ OOP (Object Oriented Programming) \cite{java}
  ...
  \subsection{Library Tools}
    \begin{itemize}
      ...
      \item BeautifulSoup
          ...
          \hspace{1cm}เป็น Library สำหรับทำ Web scraping หรือการดึงข้อมูลผ่านทางหน้าเว็บไซต์ ซึ่งหลังจากดึงข้อมูลเสร็จ จะเข้าสู่กระบวนการสกัด (Extract) เอา
          เฉพาะข้อมูลที่ต้องการ เพื่อนำมาเก็บไว้ในรูปแบบที่ต้องการเป็นแหล่ง Data Source เพื่อใช้งานต่อไป โดยจะใช้ภาษา Python ในการเขียน Script \cite{beautifulsoup}
...
\chapter{ผลการดำเนินงาน}
  ...
  \section{การเก็บข้อมูล}
    ...
    แล้วจึงเก็บ URL ของบทความต่าง ๆ และวิธีที่สอง คือ การอ่าน URL ผ่าน Request โดยเว็บไซต์จะทำการส่ง Request ร้องขอเพื่อดูบทความเพิ่มเติม ได้ผลลัพธ์ดังรูปที่ \ref{fig:col_link}
    \begin{figure}[!ht]\centering
      \includegraphics[width=\textwidth]{./img/data_col1.png}
      \caption{ตัวอย่างการเก็บ URL จากหน้าเว็ปไซต์}\label{fig:col_link}
    \end{figure}
    
    \hspace{1cm}เมื่อได้ URL มาครบตามที่ต้องการแล้ว จะทำการดึงข้อมูลเป็นไฟล์ HTML จาก URL ที่เก็บมาจากหน้าเว็บไซต์ ได้ผลลัพธ์ดังรูปที่ \ref{fig:html_file}
    \begin{figure}[!ht]\centering
      \includegraphics[width=\textwidth]{./img/data_col2.png}
      \caption{ตัวอย่างการดึงข้อมูลเป็นไฟล์ HTML จาก URL ที่เก็บมาจากหน้าเว็บไซต์}\label{fig:html_file}
    \end{figure}
    \newpage
    \hspace{1cm}ทำการเข้าถึงไฟล์ HTML ที่ได้จาก URL ที่เก็บมาจากหน้าเว็บไซต์ จากนั้นทำการดึงเนื้อหาบทความด้วยการใช้ Python BeautifulSoup มาเก็บไว้ 
    เพื่อเป็นชุดข้อมูลสำหรับพัฒนาโมเดล ได้ผลลัพธ์ดังรูปที่ \ref{fig:data_thai}
    \begin{figure}[!ht]\centering
      \includegraphics[width=\textwidth]{./img/data_col_thai.png}
    ...
    \begin{figure}[!ht]\centering
      \includegraphics[width=\textwidth]{./img/data_col_eng.png}
  ...
  \section{การออกแบบโมเดลสำหรับวิเคราะห์หมวดหมู่ของเนื้อหาในบทความต่าง ๆ}
    \subsection{การเตรียมข้อมูลสำหรับการพัฒนาโมเดล}
      ...
      ชุดข้อมูลที่มีเนื้อหาเป็นภาษาไทยจะมีทั้งหมด 5712 ชุด และชุดข้อมูลที่มีเนื้อหาเป็นภาษาอังกฤษจะมีทั้งหมด 4862 ชุด ซึ่งมีลักษณะข้อมูลเป็นไฟล์ Text
      ...
      \begin{longtable}[!ht]{p{0.15\linewidth}m{0.45\linewidth}}
        ...
        \endhead
        %
        อาชญากรรม                              & \multicolumn{1}{c}{2997}                        \\ %\hline
        การเงิน                                   & \multicolumn{1}{c}{999}                         \\ %\hline
        การเมือง                               & \multicolumn{1}{c}{998}                          \\ %\hline
        กีฬา                                 & \multicolumn{1}{c}{718}                          \\ \hline
        \textbf{รวม}                           & \multicolumn{1}{c}{\textbf{5712}}                        \\ \hhline{==}
      \end{longtable}
      ...
      \begin{longtable}[!ht]{p{0.15\linewidth}m{0.45\linewidth}|}
        ...
        \endhead
        %
        อาชญากรรม                              & \multicolumn{1}{c}{1740}                        \\ %\hline
        กีฬา                                   & \multicolumn{1}{c}{1272}                         \\ %\hline
        การเมือง                               & \multicolumn{1}{c}{980}                          \\ %\hline
        ธุรกิจ                                 & \multicolumn{1}{c}{336}                          \\ %\hline
        บันเทิง                                & \multicolumn{1}{c}{273}                          \\ %\hline
        เทคโนโลยี                              & \multicolumn{1}{c}{261}                          \\ \hline
        \textbf{รวม}                           & \multicolumn{1}{c}{\textbf{4862}}                        \\ \hhline{==}
      \end{longtable}
      \newpage
      ...
      \begin{longtable}[!ht]{lcc}
        ...
        \endhead
        %
        อาชญากรรม    & 2397 & 600 \\ %\hline
        การเงิน       & 799  & 200  \\ %\hline
        กีฬา         & 798 & 200 \\ %\hline
        การเมือง     & 575  & 143 \\ \hline
        \textbf{รวม} & \textbf{4569} & \textbf{1143} \\ \hhline{===}
      \end{longtable} 
      ...
      \begin{longtable}[!ht]{lcc}
        ...
        \endhead
        %
        อาชญากรรม    & 1392 & 348 \\ %\hline
        กีฬา         & 1017 & 255 \\ %\hline
        การเมือง     & 784  & 196 \\ %\hline
        ธุรกิจ       & 269  & 67  \\ %\hline
        บันเทิง      & 218  & 55  \\ %\hline
        เทคโนโลยี    & 209  & 52  \\ \hline
        \textbf{รวม} & \textbf{3889} & \textbf{973} \\ \hhline{===}
      \end{longtable} 
    ...
    \subsection{Exploratory Data Analysis}
      \subsubsection{ชุดข้อมูลที่มีเนื้อหาเป็นภาษาไทย}
        ...
        \begin{longtable}[!ht]{ccccccc}
          \caption{ตารางแสดงค่าทางสถิติของจำนวนคำในเนื้อหาที่เป็นภาษาไทยทั้งหมด}
          ...
          \endhead
          %
          266.86 & 189.46 & 24.00 & 152.00 & 227.00 & 328.00 & 3641.00  \\ \hhline{=======}%\hline
        \end{longtable}
        ...
        (ตารางที่:\ref{tbl:thai_stat_all}) พบว่า จำนวนคำในชุดข้อมูลที่มีเนื้อหาเป็นภาษาไทยส่วนใหญ่จะมีค่าอยู่ที่ 150-350 คำ โดยจำนวนคำที่น้อยที่สุดในชุดข้อมูล คือ 24 คำ
        และจำนวนคำที่มากที่สุดในชุดข้อมูล คือ 3641 คำ
        
        \begin{longtable}[!ht]{lccccccc}
          \caption{ตารางแสดงค่าทางสถิติของจำนวนคำในเนื้อหาที่เป็นภาษาไทยของแต่ละหมวดหมู่}
          \label{tbl:thai_stat}\\
          \hhline{========}
          \multicolumn{1}{c}{\textbf{หมวดหมู่}} & \textbf{Mean} & \textbf{STD} & \textbf{Min} & \textbf{Q1} & \textbf{Q2} & \textbf{Q3} & \textbf{Max}\\ \hline
          \endhead
          %
          อาชญากรรม    & 304.82 & 165.36 & 70.00 & 203.00 & 273.00 & 359.00 & 2007.00  \\ %\hline
          การเงิน        & 186.30 & 147.83 & 24.00 & 84.00 & 138.00 & 235.50 & 781.00  \\ %\hline
          กีฬา          & 272.36 & 365.67 & 56.00 & 142.00 & 183.00 & 297.75 & 3641.00  \\ %\hline
          การเมือง       & 212.81 & 185.24 & 46.00 & 125.00 & 175.00 & 255.75 & 2174.00  \\ \hhline{========}
        \end{longtable}
        \begin{figure}[!ht]\centering
          \includegraphics[width=\textwidth]{./img/thai_stat/boxplot_all.png}
          \caption{ลักษณะของจำนวนคำในเนื้อหาที่เป็นภาษาไทยของแต่ละหมวดหมู่}\label{fig:thai_boxplot}
        \end{figure}
        \hspace{1cm}เนื่องจากในแต่หมวดหมู่ของชุดข้อมูลมีขนาดของข้อมูลแตกต่างกัน ซึ่งในชุดข้อมูลที่มีเนื้อหาเป็นภาษาไทยจะมีทั้งหมด 4 หมวดหมู่ด้วยกัน
        ...
        พบว่า จำนวนคำของเนื้อหาในหมวดหมู่อาชญากรรมส่วนใหญ่จะมีค่ามากกว่าหมวดหมู่อื่น ในขณะที่จำนวนคำของเนื้อหาในหมวดหมู่การเงินส่วนใหญ่จะมีค่าน้อยกว่าหมวดหมู่อื่น
        นอกจากนี้ยังพบว่า จำนวนคำของชุดข้อมูลในหมวดหมู่กีฬามีการกระจายตัวของกลุ่มข้อมูลสูงสุดและจำนวนคำของชุดข้อมูลในหมวดหมู่การเงินมีการกระจายตัวของกลุ่มข้อมูลต่ำสุด
        ซึ่งสังเกตได้จากค่า STD ในตารางที่ \ref{tbl:thai_stat}
        \newpage
        \begin{figure}[!ht]\centering
          \includegraphics[width=0.7\textwidth]{./img/thai_stat/crime_bar.png}
          \caption{10 คำที่พบได้มากที่สุดในชุดข้อมูลที่เป็นภาษาไทยของหมวดหมู่อาชญากร}\label{fig:crime_bar_th}
        \end{figure}
        \begin{figure}[!ht]\centering
        ...
        \begin{figure}[!ht]\centering
          ...
          \caption{10 คำที่พบได้มากที่สุดในชุดข้อมูลที่เป็นภาษาไทยของหมวดหมู่การเงิน}\label{fig:money_bar_th}
        \end{figure}
        \newpage
        \begin{figure}[!ht]\centering
        ...
        เช่น ปี ซึ่งถือว่าเป็นคำทั่วไป ไม่ได้มีความสำคัญมากสำหรับข้อมูล 
        \begin{figure}[!ht]\centering
          \begin{subfigure}{0.49\textwidth}
            \includegraphics[width=\linewidth]{./img/thai_stat/crime_wc.png} 
            \caption{หมวดหมู่อาชญากร}
            \label{fig:subim_th1}
          \end{subfigure}
          \begin{subfigure}{0.49\textwidth}
      ...
      \subsubsection{ชุดข้อมูลที่มีเนื้อหาเป็นภาษาอังกฤษ}
        \hspace{1cm}จากการสำรวจชุดข้อมูลที่มีเนื้อหาเป็นภาษาอังกฤษทั้งหมด 4862 ชุด พบว่า แต่ละชุดข้อมูลมีการกระจายตัวของขนาดของข้อมูล \newline ดังนี้
        \begin{figure}[!ht]\centering
        ...
        \end{figure}
        \begin{longtable}[!ht]{ccccccc}
          \caption{ตารางแสดงค่าทางสถิติของจำนวนคำในเนื้อหาที่เป็นภาษาอังกฤษทั้งหมด}
          \label{tbl:eng_stat_all}\\
          \hhline{=======}
          \textbf{Mean} & \textbf{STD} & \textbf{Min} & \textbf{Q1} & \textbf{Q2} & \textbf{Q3} & \textbf{Max}\\ \hline
          \endhead
          %
          218.08 & 116.61 & 34.00 & 135.00 & 193.00 & 274.00 & 1927.00  \\ \hhline{=======}
        \end{longtable}
        ...
        ดังนั้นค่าเฉลี่ยของจำนวนคำในชุดข้อมูลจึงมากกว่าค่ากลางของจำนวนคำในชุดข้อมูล และเมื่อดูการกระจายตัวประกอบกับค่าทางสถิติของจำนวนคำในเนื้อหาทั้งหมด
        (ตารางที่:\ref{tbl:eng_stat_all}) พบว่า จำนวนคำในชุดข้อมูลที่มีเนื้อหาเป็นภาษาอังกฤษส่วนใหญ่จะมีค่าอยู่ที่ 100-300 คำ โดยจำนวนคำที่น้อยที่สุดในชุดข้อมูล คือ 34 คำ
        และจำนวนคำที่มากที่สุดในชุดข้อมูล คือ 1927 คำ

        \begin{longtable}[!ht]{lccccccc}
          \caption{ตารางแสดงค่าทางสถิติของจำนวนคำในเนื้อหาที่เป็นภาษาอังกฤษของแต่ละหมวดหมู่}
          \label{tbl:eng_stat}\\
          \hhline{========}
          \multicolumn{1}{c}{\textbf{หมวดหมู่}} & \textbf{Mean} & \textbf{STD} & \textbf{Min} & \textbf{Q1} & \textbf{Q2} & \textbf{Q3} & \textbf{Max}\\ \hline
          \endhead
          %
          อาชญากรรม    & 256.15 & 108.33 & 64.00 & 178.00 & 239.00 & 313.00 & 907.00  \\ %\hline
          กีฬา          & 172.29 & 92.42  & 34.00 & 111.00 & 144.50 & 209.00 & 911.00  \\ %\hline
          การเมือง       & 211.84 & 142.97 & 39.00 & 126.00 & 182.00 & 260.00 & 1927.00  \\ %\hline
          ธุรกิจ         & 190.46 & 74.28  & 75.00 & 141.75 & 178.50 & 222.00 & 505.00  \\ %\hline
          บันเทิง        & 187.74 & 105.61 & 88.00 & 131.00 & 157.00 & 210.00 & 1230.00  \\ %\hline
          เทคโนโลยี     & 278.21 & 112.12 & 102.00 & 195.00 & 259.00 & 352.00 & 829.00  \\ \hhline{========}
        \end{longtable}
        \begin{figure}[!ht]\centering
          \includegraphics[width=\textwidth]{./img/eng_stat/boxplot_tag.png}
          \caption{ลักษณะของจำนวนคำในเนื้อหาที่เป็นภาษาอังกฤษของแต่ละหมวดหมู่}\label{fig:eng_boxplot}
        \end{figure}
        \newpage
        ...
        พบว่า จำนวนคำของเนื้อหาในหมวดหมู่เทคโนโลยีส่วนใหญ่จะมีค่ามากกว่าหมวดหมู่อื่น ในขณะที่จำนวนคำของเนื้อหาในหมวดหมู่กีฬาส่วนใหญ่จะมีค่าน้อยกว่าหมวดหมู่อื่น
        นอกจากนี้ยังพบว่า จำนวนคำของชุดข้อมูลในหมวดหมู่การเมืองมีการกระจายตัวของกลุ่มข้อมูลสูงสุดและจำนวนคำของชุดข้อมูลในหมวดหมู่ธุรกิจมีการกระจายตัวของกลุ่มข้อมูลต่ำสุด
        ซึ่งสังเกตได้จากค่า STD ในตารางที่ \ref{tbl:eng_stat}

        \begin{figure}[!ht]\centering
          \includegraphics[width=0.8\textwidth]{./img/eng_stat/crime_bar.png}
          \caption{10 คำที่พบได้มากที่สุดในชุดข้อมูลที่เป็นภาษาอังกฤษของหมวดหมู่อาชญากร}\label{fig:crime_bar_eng}
        \end{figure}
        \newpage
        \begin{figure}[!ht]\centering
          \includegraphics[width=0.8\textwidth]{./img/eng_stat/sport_bar.png}
          \caption{10 คำที่พบได้มากที่สุดในชุดข้อมูลที่เป็นภาษาอังกฤษของหมวดหมู่กีฬา}\label{fig:sport_bar_eng}
        \end{figure}
        \begin{figure}[!ht]\centering
          \includegraphics[width=0.8\textwidth]{./img/eng_stat/polit_bar.png}
          \caption{10 คำที่พบได้มากที่สุดในชุดข้อมูลที่เป็นภาษาอังกฤษของหมวดหมู่การเมือง}\label{fig:polit_bar_eng}
        \end{figure}
        \begin{figure}[!ht]\centering
          \includegraphics[width=0.8\textwidth]{./img/eng_stat/bus_bar.png}
          \caption{10 คำที่พบได้มากที่สุดในชุดข้อมูลที่เป็นภาษาอังกฤษของหมวดหมู่ธุรกิจ}\label{fig:bus_bar_eng}
        \end{figure}
        \begin{figure}[!ht]\centering
          \includegraphics[width=0.8\textwidth]{./img/eng_stat/ent_bar.png}
          \caption{10 คำที่พบได้มากที่สุดในชุดข้อมูลที่เป็นภาษาอังกฤษของหมวดหมู่บันเทิง}\label{fig:ent_bar_eng}
        \end{figure}
        \begin{figure}[!ht]\centering
          \includegraphics[width=0.8\textwidth]{./img/eng_stat/tech_bar.png}
    ...
    \subsection{การทำ Text Representation ด้วย TF-IDF}
      ...
      \begin{longtable}{llll}
        ...
        %
        อาชญากร &
          \begin{tabular}[c]{@{}l@{}}- ทีม\\ - ตำรวจ\\ - ราคา\end{tabular} &
          การเงิน &
          \begin{tabular}[c]{@{}l@{}}- ลงทะเบียน\\ - บาท\\ - ราคา\end{tabular} \\ \hline
        กีฬา &
          \begin{tabular}[c]{@{}l@{}}- ลีก\\ - เกม\\ - ทีม\end{tabular} &
          การเมือง &
          \begin{tabular}[c]{@{}l@{}}- ประยุทธ์\\ - ส.ส.\\ - พรรค\end{tabular} \\ \hhline{====}
      \end{longtable}
      \newpage
      \begin{longtable}{llllll}
        ...
        %
        อาชญากร &
          \begin{tabular}[c]{@{}l@{}}- arrest\\ - officer\\ - police\end{tabular} &
          \begin{tabular}[c]{@{}l@{}}- maj gen\\ - police officer\\ - police station\end{tabular} &
          ธุรกิจ &
          \begin{tabular}[c]{@{}l@{}}- firm\\ - growth\\ - bn\end{tabular} &
          \begin{tabular}[c]{@{}l@{}}- economic growth\\ - analyst say\\ - bn bn\end{tabular} \\ \hline
        กีฬา &
          \begin{tabular}[c]{@{}l@{}}- league\\ - game\\ - team\end{tabular} &
          \begin{tabular}[c]{@{}l@{}}- premier league\\ - manchester unite\\ - national team\end{tabular} &
          บันเทิง &
          \begin{tabular}[c]{@{}l@{}}- album\\ - award\\ - film\end{tabular} &
          \begin{tabular}[c]{@{}l@{}}- film festival\\ - best film\\ - box office\end{tabular} \\ \hline
        การเมือง &
          \begin{tabular}[c]{@{}l@{}}- prime\\ - minister\\ - party\end{tabular} &
          \begin{tabular}[c]{@{}l@{}}- house representative\\ - gen prayuth\\ - prime minister\end{tabular} &
          เทคโนโลยี &
          \begin{tabular}[c]{@{}l@{}}- broadband\\ - microsoft\\ - software\end{tabular} &
          \begin{tabular}[c]{@{}l@{}}- music player\\ - consumer electronic\\ - search engine\end{tabular} \\ \hhline{======}
      \end{longtable}
      ...
      แต่สำหรับภาษาไทย คำประสมส่วนใหญ่มักเป็นคำที่ติดกันและไม่มีการเว้นวรรค เช่น สถานีตำรวจ แม่น้ำ ซึ่งเมื่อนำมาแบ่งแยกเป็นคำ ก็อาจนับเป็นคำเดียว จึงทำเพียง Unigram 
      ...
      และมีบางคำที่มีความสัมพันธ์ใกล้เคียงกับหมวดหมู่อาชญากร นอกจากนี้หมวดหมู่การเงินในชุดข้อมูลที่เป็นภาษาไทยก็มีความสัมพันธ์ของข้อมูลค่อนข้างกระจายตัวเช่นกัน
    ...
    \subsection{การเลือก Model ระหว่าง Random Forest KNN และ NN}
      ...
      โดยใช้การทำ Text Representation ด้วย TF-IDF เป็นขhอมูลนำเข้าสำหรับการพัฒนาโมเดล ซึ่งได้ประสิทธิภาพดังนี้
      \begin{longtable}{clc}
        ...
        \endhead
        %
        Random Forest      & \begin{tabular}[c]{@{}l@{}}n\_estimators: 350, \\ max\_depth: 81, \\ min\_samples\_split: 5, \\ min\_samples\_leaf: 2\end{tabular}              & 0.969 \\ \hline
        K-Neighbor Nearest & \begin{tabular}[c]{@{}l@{}}n\_neighbors: 6, \\ weights: 'distance',\\ metric: 'euclidean',\\ n\_jobs = -1\end{tabular}                      & 0.955 \\ \hline
        LSTM               & \begin{tabular}[c]{@{}l@{}}units: 251, \\ dropout: 0.192,\\ activation: softmax,\\ optimizers: Adam,\\ learning\_rate=0.00082\end{tabular} & 0.399 \\ \hhline{===}
      \end{longtable}
      \begin{longtable}{clc}
        ...
        \endhead
        %
        Random Forest      & \begin{tabular}[c]{@{}l@{}}n\_estimators: 300, \\ max\_depth: 148, \\ min\_samples\_split: 7, \\ min\_samples\_leaf: 1\end{tabular}              & 0.952 \\ \hline
        K-Neighbor Nearest & \begin{tabular}[c]{@{}l@{}}n\_neighbors: 10, \\ weights: 'distance',\\ metric: 'euclidean',\\ n\_jobs = -1\end{tabular}                      & 0.952 \\ \hline
        LSTM               & \begin{tabular}[c]{@{}l@{}}units: 65, \\ dropout: 0.168,\\ activation: softmax,\\ optimizers: Adam,\\ learning\_rate=0.00030\end{tabular} & 0.367 \\ \hhline{===}
      \end{longtable}
      ...
      โดยมีค่า Accuracy อยู่ที่ 0.35-0.40 ทั้งนี้อาจเป็นเพราะว่า Text Representation ที่ได้จากการทำ TF-IDF อาจมีขนาดใหญ่เกินไปหรือไม่เหมาะสมกับโมเดล LSTM
      ...
      \begin{longtable}[!ht]{lcccc}
        ...
        \endhead
        %
        LSTM สำหรับภาษาไทย    & 0.948             & 0.938                                  & 0.918                               & 0.925                                 \\
        LSTM สำหรับภาษาอังกฤษ & 0.943             & 0.930                                  & 0.918                               & 0.923                                 \\ \hhline{=====}
      \end{longtable}
      ...
      พบว่าโมเดล LSTM มีประสิทธิภาพสูงขึ้น โดยมีค่า Accuracy สูงถึง 0.948 สำหรับชุดข้อมูลที่เป็นภาษาไทยและมีค่า Accuracy สูงถึง 0.943 สำหรับชุดข้อมูลที่เป็นภาษาอังกฤษ
      ...
      \begin{longtable}[!ht]{lccccccccc}
        ...
        \endlastfoot
        %
        อาชญากร                            & 0.96         & 0.99         & 0.98         & 0.95           & 0.99           & 0.97          & 0.95       & 0.98       & 0.96      \\
        กีฬา                               & 0.98         & 0.99         & 0.99         & 0.98           & 0.98           & 0.98          & 0.96       & 1.00       & 0.98      \\
        การเงิน                            & 0.97         & 0.96         & 0.97         & 0.95           & 0.96           & 0.95          & 0.99       & 0.92       & 0.95      \\
        การเมือง                           & 0.96         & 0.83         & 0.89         & 0.95           & 0.78           & 0.85          & 0.85       & 0.77       & 0.81      \\ \hline
        \textbf{Accuracy}                  & \multicolumn{3}{c}{\textbf{0.969}}         & \multicolumn{3}{c}{\textbf{0.955}}              & \multicolumn{3}{c}{\textbf{0.948}} \\ \hhline{==========}
      \end{longtable}
      \begin{longtable}{lccccccccc}
        ...
        \multirow{2}{*}{\textbf{หมวดหมู่}} & \multicolumn{3}{c}{\textbf{Random Forest}} & \multicolumn{3}{c}{\textbf{K-Neighbor Nearest}} & \multicolumn{3}{c}{\textbf{LSTM}}  \\
         &
          ...
          \endlastfoot
          %
          อาชญากร                            & 0.95         & 0.99         & 0.97         & 0.95           & 0.99           & 0.97          & 0.95       & 0.98      & 0.96      \\
          กีฬา                               & 0.96         & 0.98         & 0.97         & 0.97           & 0.98           & 0.97          & 0.98       & 0.98      & 0.98      \\
          การเมือง                           & 0.92         & 0.92         & 0.92         & 0.95           & 0.90           & 0.92          & 0.92       & 0.88      & 0.90      \\
          ธุรกิจ                             & 0.98         & 0.85         & 0.91         & 0.93           & 0.84           & 0.88          & 0.88       & 0.88      & 0.88      \\
          บันเทิง                            & 1.00         & 0.84         & 0.91         & 0.96           & 0.91           & 0.93          & 0.93       & 0.87      & 0.90      \\
          เทคโนโลยี                          & 0.98         & 0.90         & 0.94         & 0.94           & 0.94           & 0.94          & 0.92       & 0.92      & 0.92      \\ \hline
          \textbf{Accuracy}                  & \multicolumn{3}{c}{\textbf{0.952}}         & \multicolumn{3}{c}{\textbf{0.952}}              & \multicolumn{3}{c}{\textbf{0.943}} \\ \hhline{==========}
      \end{longtable}
      ...
      จึงเป็นโมเดลที่มีประสิทธิภาพและความแม่นยำสูงสุดสำหรับชุดข้อมูลที่มีเนื้อหาเป็นภาษาไทย และจากการสังเกตเพิ่มเติม พบว่า ในชุดข้อมูลที่มีเนื้อหาเป็นภาษาไทย
      ...
      จึงทำให้ความสามารถในการทำนายลดลง ในขณะที่การกระจายตัวของชุดข้อมูลของหมวดหมู่กีฬาค่อนข้างมีความสัมพันธ์กันอย่างชัดเจน 

      \hspace{1cm}สำหรับชุดข้อมูลที่มีเนื้อหาเป็นภาษาอังกฤษ จากตารางที่ \ref{tbl:class_report_eng} พบว่า โมเดล Random Forest และโมเดล K-Neighbor Nearest
      เป็นโมเดลที่มีค่า Accuracy สูงใกล้เคียงกัน โดยมีค่า Accuracy อยู่ที่ 0.952 และจากการสังเกตเพิ่มเติม พบว่า ในชุดข้อมูลที่มีเนื้อหาเป็นอังกฤษ
      ...
      จะเห็นได้ว่าการทำโมเดลด้วยชุดข้อมูลที่มีเนื้อหาเป็นภาษาไทยจะทำให้ได้โมเดลที่มีประสิทธิภาพมากกว่าการทำโมเดลด้วยชุดข้อมูลที่มีเนื้อหาเป็นภาษาอังกฤษ 
      ทั้งนี้อาจเกิดจากการแปลภาษาที่ผิดพลาดในบางคำ จึงส่งผลต่อประสิทธิภาพของการทำโมเดลด้วยชุดข้อมูลที่มีเนื้อหาเป็นภาษาอังกฤษ
      ซึ่งโมเดลที่มีค่า Accuracy สูงสุด คือ โมเดล Random Forest ที่ใช้ชุดข้อมูลที่มีเนื้อหาเป็นภาษาไทย โดยมีค่า Accuracy สูงถึง 0.969
    
    \subsection{การทดสอบโมเดล}
      \hspace{1cm}นำโมเดลที่ได้ค่า Accuracy สูงที่สุด มาทำการทดสอบด้วยชุดข้อมูลจากภายนอก โดยจะใช้ชุดข้อมูลที่มีหมวดหมู่กำกับ 100 ชุด
      และใช้ชุดข้อมูลที่ไม่มีหมวดหมู่กำกับ 50 ชุด
      \newpage
